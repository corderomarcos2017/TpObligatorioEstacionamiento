...
<div class="container">
  <div class="jumbotron mt-3">
    ...
    <p class="lead">Seguro es un problema de ud. nuestros sistemas funcionana bien!!! </p>
    <a class="btn btn-lg btn-primary" href="index.php" role="button">Ir al Inicio &raquo;</a>
  </div>
</div>
